...
import c.aapreneur.vpay.Fragment.add_ref_no;
import c.aapreneur.vpay.Fragment.bank;
import c.aapreneur.vpay.Fragment.form;
import c.aapreneur.vpay.Fragment.profile;
import c.aapreneur.vpay.app.utils.CrossfadeWrapper;
import c.aapreneur.vpay.app.utils.SystemUtils;
...
public class Main2Activity extends AppCompatActivity {
    ...
    class ReadProfile extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... params) {
            ...
            JSONArray jsonArray = c.aapreneur.vpay.Resources.Configuration.readProfile(user.getUid());
            try {
    ...
    class ReadAccount extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... params) {
            mAuth = FirebaseAuth.getInstance();
            FirebaseUser user = mAuth.getCurrentUser();
            JSONArray jsonArray = c.aapreneur.vpay.Resources.Configuration.readAccount(user.getUid());
            try {
